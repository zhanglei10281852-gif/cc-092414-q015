...
from app.food.governance_router import router as food_governance_router
from app.food.governance import ensure_governance_schema
...
app.include_router(food_governance_router)
